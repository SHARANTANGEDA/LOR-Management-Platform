				...
				<div className='col-md-12 '>
					...
					<div className='d-flex justify-content-between row col-md-12'>
						<div className='col-md-6 '>
							<div className='d-flex justify-content-start' style={{marginLeft:'3px'}}>
								{imageContent}
							</div>

							{info}
							<div className="row col-md-12 d-flex justify-content-between" style={{width: '100%', marginTop: '5px', marginBottom: '5px'}}>
								<div className='col-md-12 '>
									<input type="file" id='picture' onChange={this.fileChanged.bind(this)} required name='file'
												 accept="image/png, image/jpeg, image/jpg"
												 style={{
													 border: '1.5px', borderStyle: 'solid',
													 borderRadius: '5px', margin: '5px'
												 }}/>
									{!this.state.spinner ? uploadBtn : null}
								</div>
							</div>
							<div className="row col-md-12 d-flex justify-content-center" style={{width: '100%',  marginTop: '5px', marginBottom: '5px'}}>
								{this.state.spinner ? spin : null}
							</div>
						</div>
						<div className='col-md-6'>
							<ul style={{listStyleType: 'round', lineHeight: '50px', fontSize: '12pt'}}>
								<h5 className='row text-center fl1 fs-headline1' style={{margin: '5px'}}>
									Guidelines for uploading profile picture:</h5>
								<li>Profile picture helps faculty recognize you faster</li>
								<li>Make sure you upload a clear recent picture of your face</li>
								<li>Full length photos in which your face is less clear is not advised</li>
							</ul>
						</div>
					</div>
